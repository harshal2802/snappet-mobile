...
**Created**: 2026-07-16 · **Status**: 01 merged (#292) · 02 merged (#293) · 03 implemented (tagging + Clips payoff)
...
| 03 | `03-festival-tagging-and-clips.md` | Matcher wired to session media, tag-review timeline sheet, artist·stage Clips posts + 🎪 chip, set detail (HR curve, peak-at-drop), set/festival reels via shared `ReelView`, recap. | **implemented** |
