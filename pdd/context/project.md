...
(nullable columns, committed schema, extended baseline test — one self-contained column-set the reviewer
renumbers to v6 to reconcile with Wave 2's independent v5). **#91:** the Kilter share loop closes —
