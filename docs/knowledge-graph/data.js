...
const nodes = [
  ...
  { id: "journal-root", label: "JournalRootView", type: "screen", group: "journal", category: "productivity", platform: "ios",
    file: "ios/App/Snappet/Features/Journal/JournalRootView.swift", desc: "Searchable list of entries (tag chips). Pushes an entry to its editor; presents a new entry. Swipe-to-delete requires confirmation dialog.", tags: ["root","search","confirm-delete"], shot: "../screenshots/06-journal.png" },
  { id: "journal-editor", label: "JournalEditorView", type: "screen", group: "journal", category: "productivity", platform: "ios+android",
    file: "ios/App/Snappet/Features/Journal/JournalEditorView.swift", desc: "Compose/edit an entry with tags. Reached by pushing an existing JournalEntry or by the new-entry item. Cleans up blank new entries on back-swipe (onDisappear guard).", tags: ["editor","cleanup"] },
  ...
  { id: "expense-root", label: "ExpenseRootView", type: "screen", group: "expense", category: "finance", platform: "ios",
    file: "ios/App/Snappet/Features/Expense/ExpenseRootView.swift", desc: "List of groups + balances. Pushes a group; presents New Group. Group deletion requires confirmation and cascades to orphaned ExpenseRecords.", tags: ["root","list","confirm-delete"], shot: "../screenshots/08-expenses.png" },
  ...
  { id: "budget-root", label: "BudgetRootView", type: "screen", group: "budget", category: "finance", platform: "ios",
    file: "ios/App/Snappet/Features/Budget/BudgetRootView.swift", desc: "Month summary + spend-by-category. Pushes a category and Trends; presents add/edit category and add transaction. Category deletion requires confirmation showing how many transactions will be removed.", tags: ["root","charts","confirm-delete"], shot: "../screenshots/09-budget.png" },
