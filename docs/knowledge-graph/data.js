...
const nodes = [
  ...
  { id: "kilter-catalog-store", label: "KilterCatalogStore", type: "service", group: "kilter", category: "fitness", platform: "ios+android",
    file: "ios/App/Snappet/Features/Kilter/KilterCatalogStore.swift", desc: "Owns the on-device, user-installed catalog LIBRARY (iOS: catalogs/<id>/catalog.sqlite3 + meta sidecar, with an active-catalog pointer; Android still single-file) — install() adds + activates a new entry, installed()/remove(id:)/setActive(id:) manage the library, clear() wipes it, and a legacy single-file migration folds old installs in. The app ships NO catalog (#42); KilterCatalog opens the ACTIVE catalog, and when none is installed the module shows the opt-in screen. A change notification drives the reader reload.", tags: ["catalog","storage","library","on-device","#42"] },
  ...
  { id: "kilter-catalog-sync", label: "KilterCatalogSyncView", type: "screen", group: "kilter", category: "fitness", platform: "ios",
