...
(function () {
  ...
  function renderDetail(n) {
    ...
    el.innerHTML = `
      ...
      <div class="body">
        ${n.shot ? `<div class="shots"><figure class="shotfig"><img class="shot" src="${n.shot}" alt="${n.label} light screenshot" loading="lazy"><figcaption>Light</figcaption></figure><figure class="shotfig"><img class="shot" src="${n.shot.replace(/\.png$/, "-dark.png")}" alt="${n.label} dark screenshot" loading="lazy" onerror="this.closest('.shotfig').remove()"><figcaption>Dark</figcaption></figure></div>` : ""}
