...
object PulseColors {
    ...
    // Status text — success/warning that pass 4.5:1 on the mode's surfaces (issue #96).
    // The old hardcoded greens/ambers (#1E7E48 on #1E1E22 ≈ 2.6:1) were unreadable in dark.
    val SuccessLight = Color(0xFF1B7A43)
